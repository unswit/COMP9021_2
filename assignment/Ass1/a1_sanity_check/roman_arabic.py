...
def convert(n):
    ...
    if c.isdigit():
       roman_num = roman.intToRoman(int(input_list[2]))
       ...
       return "".join(new_roman)
        ...
        convert_list = list(input_list[2])
        convert_num = 0
    ...
    if check_pattern1(a,b,c):
        if c.isdigit():
            if check_num(c):
                ...
                if len(input_list)== 5:
                    print("Sure! It is", convert(input_list[2]), end='')
                else:
                    print("Sure! It is", roman.intToRoman(int(input_list[2])),end='')
        elif type(c) == str:
            if check_str(c):
                print("Hey, ask me something that's not impossible to do!",end='')
            else:
                if len(input_list) == 5:
                    ...
                    print("Sure! It is", ans.romanToInt((input_list[2])),end='')
    else:
        print("I don't get what you want, sorry mate!", end='')
